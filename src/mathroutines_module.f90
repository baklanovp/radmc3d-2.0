...
!-------------------------------------------------------------------
   subroutine remap_function(nold,xold,fold,nnew,xnew,fnew,av,elow,eup,ierror)
      implicit none
      integer, intent(in) :: nold,nnew,elow,eup,av
      double precision, intent(in) :: xold(1:nold),fold(1:nold)
      double precision, intent(in) :: xnew(1:nnew)
      double precision, intent(out) :: fnew(1:nnew)
...
! C  (C) Copr. 1986-92 Numerical Recipes Software =v1.9"217..
   ...
   pure SUBROUTINE hunt(xx,n,x,jlo)
      ...
      INTEGER, intent(in) :: n
      doubleprecision, intent(in) :: x,xx(n)
      INTEGER inc,jhi,jm
      LOGICAL ascnd
      ascnd=xx(n).gt.xx(1)
...
! C  (C) Copr. 1986-92 Numerical Recipes Software =v1.9"217..
   ...
   pure SUBROUTINE lubksb(a,n,np,indx,b)
...
! (C) Copr. 1986-92 Numerical Recipes Software =v1.9"217..
   ...
   pure SUBROUTINE ludcmp(a,n,np,indx,d,success)
